...
제2호 오해유발: 자격/경력 과장, 허위 학력·자격 표시 등 오해를 불러올 수 있는 표현
  ※ 주의: "전문", "전담" 표시는 2021년 개정으로 자유 사용 허용됨. "이혼전문변호사", "형사전문" 등은 적법한 취급업무 표시이므로 위반이 아님!
...
7. 허위 자격: 실제 없는 자격/학력을 표시하거나, "대한변협 등록 전문변호사"를 사칭하는 경우

## 위반이 아닌 것 (오탐 주의!)
- "○○전문변호사", "○○전담", "○○특화": 2021년 개정으로 자유 사용 허용. 취급업무 표시는 적법
- 사무소 주소, 연락처, 학력, 경력 사실 기재: 적법한 정보 제공
- 취급 업무 분야 나열: 적법
